    ...
    $('#btnSubmit').click(function(event) {
        ...
        if (form[0].checkValidity() === false) {
          ...
          $.ajax({
            ...
            $('.showAvailableValue').css('background', '#ddfff3').fadeIn();
            $('#btnSubmit').hide('fast');
  ...
  function listProducts(){
      ...
      request.fail(function() {
          $('.loadProducts').html('<div class="row">Produtos não localizados!<div>');
      });
  ...
  function openProduct(keyName){
    ...
    requestProduct.fail(function() {
        $('.productBodyModal').html('<div class="col-lg-12">Produto não localizado!<div>');
    });
